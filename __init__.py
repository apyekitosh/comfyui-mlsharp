...
from .src.mlsharp.nodes import NODE_CLASS_MAPPINGS as _GAUSSIAN_NODE_CLASS_MAPPINGS
from .src.mlsharp.nodes import NODE_DISPLAY_NAME_MAPPINGS as _GAUSSIAN_NODE_DISPLAY_NAME_MAPPINGS
from .src.mlsharp.shot_render import NODE_CLASS_MAPPINGS as _SHOT_NODE_CLASS_MAPPINGS
from .src.mlsharp.shot_render import NODE_DISPLAY_NAME_MAPPINGS as _SHOT_NODE_DISPLAY_NAME_MAPPINGS

NODE_CLASS_MAPPINGS = {}
NODE_CLASS_MAPPINGS.update(_GAUSSIAN_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(_SHOT_NODE_CLASS_MAPPINGS)

NODE_DISPLAY_NAME_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS.update(_GAUSSIAN_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(_SHOT_NODE_DISPLAY_NAME_MAPPINGS)
